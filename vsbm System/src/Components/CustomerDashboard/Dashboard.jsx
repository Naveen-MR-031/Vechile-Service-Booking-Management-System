...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const fetchServiceProviders = async () => {
      try {
        ...
        // Fallback: try to load from local file if server is not running
        try {
  ...
  const availableServices = [
    { key: 'general', name: 'General Service', icon: '🔧', description: 'Complete vehicle maintenance and checkup' },
    { key: 'oil', name: 'Oil Change', icon: '🛢️', description: 'Engine oil replacement and filter change' },
    { key: 'tire', name: 'Tire Service', icon: '🛞', description: 'Tire repair, replacement, and alignment' },
    { key: 'water', name: 'Water Service', icon: '💧', description: 'Cooling system and radiator service' },
    { key: 'battery', name: 'Battery Service', icon: '🔋', description: 'Battery testing, charging, and replacement' },
    { key: 'detailing', name: 'Car Detailing', icon: '✨', description: 'Interior and exterior car cleaning' },
    { key: 'engine', name: 'Engine Repair', icon: '⚙️', description: 'Engine diagnostics and repair services' },
    { key: 'ac', name: 'AC Service', icon: '❄️', description: 'Air conditioning repair and maintenance' }
  ];
  ...
  return (
    <div className={styles.dashboard}>
      ...
      <div className={styles.welcomeHeader}>
        ...
        <p className={styles.welcomeSubtitle}>Find and book trusted vehicle service providers in your area</p>
      </div>
